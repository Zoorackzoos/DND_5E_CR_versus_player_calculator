...
def get_row_based_on_dict_on_param_type_and_string(dict_in_question, param_type, string,tab_amount="\t"):
    print(tab_amount,"get_row_based_on_dict_on_param_type_and_string")
    tab_amount += "\t"
...
if __name__ == "__main__":
    tab_amount = "\t"
    get_row_based_on_dict_on_param_type_and_string(dict_in_question=monsters_all_stats_dict,param_type="Type",string="Humanoid",tab_amount=tab_amount)