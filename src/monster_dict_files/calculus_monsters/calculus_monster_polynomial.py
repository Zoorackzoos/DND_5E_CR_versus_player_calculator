...
calculus_monster_polynomial_monster_dict = \
    {
        ...
        spreadsheet_enums.SpreadsheetKeysEnums.SAVING_THROWS.value :
            ", ".join([spreadsheet_enums.SavingThrowsEnums.INT.value, spreadsheet_enums.SavingThrowsEnums.DEX.value, spreadsheet_enums.SavingThrowsEnums.WIS.value, spreadsheet_enums.SavingThrowsEnums.CHA.value]),
