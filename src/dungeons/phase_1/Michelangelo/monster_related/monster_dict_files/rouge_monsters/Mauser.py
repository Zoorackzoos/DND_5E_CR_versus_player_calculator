...
mauser_monster_dict = \
    {
        ...
        spreadsheet_enums.SpreadsheetKeysEnums.URL.value :
            'https://docs.google.com/document/d/14QU4AysS5lk1mlsOaElzohyduXIW90Csj1U9-URapl4/edit?tab=t.0',
        ...
        spreadsheet_enums.SpreadsheetKeysEnums.BONUS_ACTION_DAMAGE.value :
            0,
        "actions" :
            [{'name': 'bite and grab', 'action_type': 'action', 'attack_type': 'melee_attack', 'hit_modifier': 4, 'damage': '3d4 + 5', 'damage_type': 'piercing', 'notes': 'if it hits you, it grabs you as well. This feeds into the “actually grab” action'}, {'name': 'actually grab', 'action_type': 'instantaneous', 'attack_type': 'saving_throw', 'save_dc': 13, 'save_stat': 'str, dex', 'damage': '2d4 + 3', 'damage_type': 'piercing'}],
    }
...
if __name__ == "__main__":
    ...
    print(
        build_replacement_python_dictionary_file_text_from_monster_dict(
            ...
            dict_variable_name='mauser_monster_dict'
        )
    )