...
def intro_the_magic_castle(tab_amount="\t"):
    ...
    skeleton_cr = get_cr_from_precise_monster_search(param_type="Name", string="Skeleton", tab_amount=tab_amount)
    skeleton_war_horse_cr = get_cr_from_precise_monster_search(param_type="Name", string="Skeleton, Warhorse", tab_amount=tab_amount)
