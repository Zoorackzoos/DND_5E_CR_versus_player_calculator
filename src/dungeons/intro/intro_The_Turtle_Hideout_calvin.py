...
from src.universal_functions.vars.monter_sheet_vars import monsters_all_stats_array
...
def intro_the_Turtle_Hideout_calvin(tab_amount="\t"):
    ...
    array_in_question = monsters_all_stats_array

    player_levels = [3,3,3,3]
    all_humanoids = get_row_from_array_based_on_search_string(search_string="humanoid", array_in_question=array_in_question, tab_amount=tab_amount)
